...
//						Rect(19,yPos,100,itemHeight));
					Pen.stringLeftJustIn(i[4][0..15],Rect(19+2,yPos,100,itemHeight));
					...
					Pen.stringLeftJustIn(i[8],Rect(119+2,yPos,100,itemHeight));
					Pen.stringLeftJustIn(i[0],Rect(219+2,yPos,100,itemHeight));
					if ((j+drawMin- 1)==index) {
						select.set;
					}{
						bgColor.set;
					...
					Pen.stringCenteredIn((i[1]+1).asString,Rect(319,yPos,30,itemHeight));
					Pen.stringCenteredIn(i[2].asString,Rect(349,yPos,30,itemHeight));
					Pen.stringCenteredIn(i[9].asString,Rect(379,yPos,30,itemHeight));
					Pen.stringCenteredIn(i[10].asString,Rect(409,yPos,30,itemHeight));
