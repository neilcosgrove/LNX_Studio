...
ExpandView {
	...
	*new { |parent, bigBounds, smallBounds, collapsed = true, button= true|
		^super.newCopyArgs( bigBounds.asRect, smallBounds.asRect ).init( parent, collapsed,button );
	}
	
	init { |parent, collapsed, doButton =true|
		time = defaultTime;
